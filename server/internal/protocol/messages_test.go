...
func TestDecodeClientRequiresExactControlPayloadsAndCanonicalBindings(t *testing.T) {
	valid := []string{
		...
		`{"protocolVersion":1,"type":"platform.connect","payload":{"resumeToken":"opaque","capabilities":["player_presence_v1","flight_chess_capture_counts_v1"]}}`,
		`{"protocolVersion":1,"type":"platform.connect","payload":{"launchTicket":"opaque","capabilities":["flight_chess_capture_counts_v1"]}}`,
	...
	invalid := []string{
		...
		`{"protocolVersion":1,"type":"platform.connect","payload":{"launchTicket":"a","capabilities":["flight_chess_capture_counts_v1","flight_chess_capture_counts_v1"]}}`,
