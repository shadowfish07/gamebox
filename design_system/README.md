...
### 2.5.0 cat-scratch palette

Additive `game.scratch*` roles define collectible ticket paper, foil, ink, enamel and rarity art for the Flutter cat-scratch game. Public controls retain the shared Material color schemes. Existing consumers require no migration.
