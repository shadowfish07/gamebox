...
static func create(dark: bool) -> Theme:
	...
	theme.set_type_variation("GameboxSettingsToggle", "CheckButton")
	...
	theme.set_color("font_color", "GameboxSettingsToggle", colors["on_surface"])
	theme.set_color("font_hover_color", "GameboxSettingsToggle", colors["on_surface"])
	theme.set_color("font_pressed_color", "GameboxSettingsToggle", colors["on_surface"])
	theme.set_font_size("font_size", "GameboxSettingsToggle", label_size)
	return theme
