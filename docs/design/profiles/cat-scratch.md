...
验收状态包含：登录页入口、未刮、部分刮开、未中奖、分组浏览、完整揭晓、新/重复收藏、图鉴筛选、原画详情、玩家列表/他人图鉴、公开/取消公开、加载失败/重试、系统返回、退出重启、窄屏明暗主题。采用组件测试与实际 Android APK 截图检查，增加收藏 HTTP 边界，以多账号 HTTP 测试和单 Android 真实客户端验证，不要求对战双设备 E2E。
