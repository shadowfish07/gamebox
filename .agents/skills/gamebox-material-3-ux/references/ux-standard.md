...
- satisfy target-runtime interaction evidence and implementing-agent UX inspection for affected UI states.
...
- supported inputs;
- key UI states the implementing agent must inspect in the target runtime;
